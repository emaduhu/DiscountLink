# DiscountLink v1.0.34 Store Assets

These assets were generated from actual app screens using the v1.0.34 screenshot harness and simulator/emulator captures. PNG deliverables were flattened to remove alpha channels while preserving dimensions.
...
- Phone splash/login images: `play_store/phone/splash_login/` — 1080x1920
- 7-inch tablet screenshots: `play_store/7_inch_tablet/screenshots/` — 1200x1920
- 7-inch tablet splash/login images: `play_store/7_inch_tablet/splash_login/` — 1200x1920
- 10-inch tablet screenshots: `play_store/10_inch_tablet/screenshots/` — 1600x2560
- 10-inch tablet splash/login images: `play_store/10_inch_tablet/splash_login/` — 1600x2560
...
- iPhone 6.9-inch splash/login images: `app_store/iphone_6_9/splash_login/` — 1320x2868
- iPad 13-inch screenshots: `app_store/ipad_13/screenshots/` — 2048x2732
- iPad 13-inch splash/login images: `app_store/ipad_13/splash_login/` — 2048x2732
