...
<div class="wrap">
    ...
    <script>
        ...
        const navLinks = Array.from(document.querySelectorAll('.side-menu .nav a'));
        ...
        if ('IntersectionObserver' in window) {
            ...
            document.querySelectorAll('.main-content .section[id]').forEach((section) => observer.observe(section));
        }
